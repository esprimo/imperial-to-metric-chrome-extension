...
const toConvert = [
  { regex: new RegExp('([0-9]+(\.[0-9]+)?) ?mi(les?)?([.!?,; ]|$)', 'i'),     unit: 'km', multiplier: 1.60934  },
  { regex: new RegExp('([0-9]+(\.[0-9]+)?) ?f(ee|oo)?t([.!?,; ]|$)', 'i'),    unit: 'm',  multiplier: 1.60934  },
  { regex: new RegExp('([0-9]+(\.[0-9]+)?) ?yards([.!?,; ]|$)', 'i'),         unit: 'm',  multiplier: 1.60934  },
  { regex: new RegExp('([0-9]+(\.[0-9]+)?) ?(pounds?|lbs)([.!?,; ]|$)', 'i'), unit: 'kg', multiplier: 0.453592 },
